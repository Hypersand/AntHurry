INSERT INTO MEMBER (username, nickname, password, phone_number, provider_type_code, coin) VALUES ('user1', 'User1', 'password123', '010-1234-5678', 'kakao', 0);
INSERT INTO MEMBER (username, nickname, password, phone_number, provider_type_code, coin) VALUES ('user2', 'User2', 'password123', '010-2345-6789', 'kakao', 0);
INSERT INTO MEMBER (username, nickname, password, phone_number, provider_type_code, coin) VALUES ('user3', 'User3', 'password123', '010-3456-7890', 'kakao', 0);
INSERT INTO MEMBER (username, nickname, password, phone_number, provider_type_code, coin) VALUES ('user4', 'User4', 'password123', '010-4567-8901', 'kakao', 0);
INSERT INTO MEMBER (username, nickname, password, phone_number, provider_type_code, coin) VALUES ('admin', 'Admin', 'password123', '010-5678-9012', 'kakao', 0);
...
INSERT INTO REVIEW (content, rating, trade_status_id) VALUES ('내용1', 1.0, 1);
INSERT INTO REVIEW (content, rating, trade_status_id) VALUES ('내용2', 2.0, 2);
INSERT INTO REVIEW (content, rating, trade_status_id) VALUES ('내용3', 3.0, 3);
